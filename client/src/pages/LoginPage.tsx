...
const AppLogo = () => (
  <div className="flex flex-col items-center justify-center mb-6 animate-in fade-in zoom-in duration-700">
    ...
    <div className="text-center">
      ...
      <span className="text-slate-400 dark:text-slate-500 text-[9px] font-black tracking-[0.4em] uppercase block">AXION Operations Management</span>
    </div>
  </div>
);
                      ...
                      <div className="flex-1 flex flex-col justify-center">
                        ...
                        <FormControl>
                          <Input 
                            ...
                            type="text"
                            autoComplete="off"
                            placeholder="username@axion.management"
