...
export function buildLetterheadHeader(subtitle?: string): string {
  ...
  if (b.phone)   left.push(`<div style="display:flex;align-items:center;gap:6px;margin-bottom:4px;" dir="ltr"><span style="display:inline-flex;align-items:center;justify-content:center;width:18px;height:18px;border-radius:50%;background:${b.accentColor};color:#fff;font-size:10px;">☎</span>${b.phone}</div>`);
