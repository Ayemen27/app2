...
### المرحلة 1: التأسيس والبنية التحتية (Infrastructure Setup) [في انتظار البدء]
*   **المهمة 1.1:** إعداد جامع البيانات (OpenTelemetry Collector).
    *   *الإجراء:* تثبيت Collector باستخدام Helm مع تعريف Exporters الأساسية (Prometheus, Sentry).
