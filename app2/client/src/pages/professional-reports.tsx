...
export default function ProfessionalReports() {
  ...
  const handleExportWorkerStatement = async () => {
    ...
    try {
      ...
      toast({ title: "فشل في تصدير البيان", variant: "destructive" });
    } finally {
      setIsExporting(false);
    }
  };
  ...
  return (
    <div className="h-full flex flex-col bg-gradient-to-br from-slate-50 to-slate-100 overflow-hidden" dir="rtl">
      <div className="flex-1 flex flex-col overflow-y-auto">
        ...
        <div className="flex-1 px-4 md:px-6 py-6">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
            <TabsList className="grid w-full grid-cols-5 bg-white rounded-xl shadow-md border p-1 max-w-4xl">
