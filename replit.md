...
## التغييرات الأخيرة
- 2026-02-16: **تكامل المشتريات والمعدات**: إضافة حقول addToInventory و equipmentId لجدول المشتريات — إنشاء معدة تلقائياً عند تفعيل خيار "إضافة للمخزن" — إصلاح 3 مشاكل حرجة (purchasePrice mapping، quantity NaN، addToInventory flag consistency) — استبدال raw checkbox بمكون shadcn Checkbox — إبطال كاش المعدات تلقائياً عند النجاح
