...
## التغييرات الأخيرة
- 2026-02-12: ترقية أداة `apk.sh` إلى الإصدار 29.0.0 (الإصدار المعماري المستقل).
- أتمتة إصلاح بيئة الأندرويد بالكامل على السيرفر الخارجي.
- حل مشكلة تعارض الملفات المكررة (PickFirst Strategy) لضمان بناء APK ناجح.
- تصحيح توافقية Node.js v22 و Java 21 و SDK 35 برمجياً.
- إصلاح تلقائي لملفات Gradle المفقودة وهيكلية Capacitor.
- الربط الآمن والتلقائي عبر SSH باستخدام `sshpass`.
