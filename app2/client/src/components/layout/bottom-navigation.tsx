...
export default function BottomNavigation() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 bg-primary/95 backdrop-blur-sm border-t border-primary-foreground/20 z-[100] shadow-lg pointer-events-auto">
      <div className="grid grid-cols-5 h-16 w-screen">
