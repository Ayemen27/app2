...
--> statement-breakpoint
ALTER TABLE "daily_expenses" DISABLE ROW LEVEL SECURITY;--> statement-breakpoint
ALTER TABLE "equipment" DISABLE ROW LEVEL SECURITY;--> statement-breakpoint
DROP TABLE "daily_expenses" CASCADE;--> statement-breakpoint
DROP TABLE "equipment" CASCADE;--> statement-breakpoint
ALTER TABLE "autocomplete_data" ALTER COLUMN "id" SET DATA TYPE varchar;--> statement-breakpoint
ALTER TABLE "autocomplete_data" ALTER COLUMN "id" SET DEFAULT gen_random_uuid();--> statement-breakpoint
ALTER TABLE "autocomplete_data" ALTER COLUMN "last_used" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "material_purchases" ALTER COLUMN "id" SET DATA TYPE varchar;--> statement-breakpoint
ALTER TABLE "material_purchases" ALTER COLUMN "id" SET DEFAULT gen_random_uuid();--> statement-breakpoint
ALTER TABLE "material_purchases" ALTER COLUMN "project_id" SET DATA TYPE varchar;--> statement-breakpoint
ALTER TABLE "material_purchases" ALTER COLUMN "purchase_date" SET DATA TYPE text;--> statement-breakpoint
...
ALTER TABLE "worker_attendance" ALTER COLUMN "id" SET DATA TYPE varchar;--> statement-breakpoint
ALTER TABLE "worker_attendance" ALTER COLUMN "id" SET DEFAULT gen_random_uuid();--> statement-breakpoint
ALTER TABLE "worker_attendance" ALTER COLUMN "worker_id" SET DATA TYPE varchar;--> statement-breakpoint
ALTER TABLE "worker_attendance" ALTER COLUMN "project_id" SET DATA TYPE varchar;--> statement-breakpoint
ALTER TABLE "workers" ALTER COLUMN "id" SET DATA TYPE varchar;--> statement-breakpoint
ALTER TABLE "workers" ALTER COLUMN "id" SET DEFAULT gen_random_uuid();--> statement-breakpoint
ALTER TABLE "autocomplete_data" ADD COLUMN "usage_count" integer DEFAULT 1 NOT NULL;--> statement-breakpoint
ALTER TABLE "material_purchases" ADD COLUMN "supplier_id" varchar;--> statement-breakpoint
ALTER TABLE "material_purchases" ADD COLUMN "material_id" varchar NOT NULL;--> statement-breakpoint
ALTER TABLE "material_purchases" ADD COLUMN "purchase_type" text DEFAULT 'نقد' NOT NULL;--> statement-breakpoint
ALTER TABLE "material_purchases" ADD COLUMN "paid_amount" numeric(10, 2) DEFAULT '0' NOT NULL;--> statement-breakpoint
ALTER TABLE "material_purchases" ADD COLUMN "remaining_amount" numeric(10, 2) DEFAULT '0' NOT NULL;--> statement-breakpoint
ALTER TABLE "material_purchases" ADD COLUMN "invoice_number" text;--> statement-breakpoint
ALTER TABLE "material_purchases" ADD COLUMN "invoice_date" text NOT NULL;--> statement-breakpoint
ALTER TABLE "material_purchases" ADD COLUMN "due_date" text;--> statement-breakpoint
ALTER TABLE "material_purchases" ADD COLUMN "invoice_photo" text;--> statement-breakpoint
ALTER TABLE "worker_attendance" ADD COLUMN "date" text NOT NULL;--> statement-breakpoint
ALTER TABLE "worker_attendance" ADD COLUMN "start_time" text;--> statement-breakpoint
ALTER TABLE "worker_attendance" ADD COLUMN "end_time" text;--> statement-breakpoint
ALTER TABLE "worker_attendance" ADD COLUMN "work_description" text;--> statement-breakpoint
ALTER TABLE "worker_attendance" ADD COLUMN "is_present" boolean NOT NULL;--> statement-breakpoint
ALTER TABLE "worker_attendance" ADD COLUMN "work_days" numeric(3, 2) DEFAULT '1.00' NOT NULL;--> statement-breakpoint
ALTER TABLE "worker_attendance" ADD COLUMN "actual_wage" numeric(10, 2) NOT NULL;--> statement-breakpoint
ALTER TABLE "worker_attendance" ADD COLUMN "paid_amount" numeric(10, 2) DEFAULT '0' NOT NULL;--> statement-breakpoint
ALTER TABLE "worker_attendance" ADD COLUMN "remaining_amount" numeric(10, 2) DEFAULT '0' NOT NULL;--> statement-breakpoint
ALTER TABLE "worker_attendance" ADD COLUMN "payment_type" text DEFAULT 'partial' NOT NULL;--> statement-breakpoint
ALTER TABLE "workers" ADD COLUMN "is_active" boolean DEFAULT true NOT NULL;--> statement-breakpoint
...
ALTER TABLE "worker_transfers" ADD CONSTRAINT "worker_transfers_project_id_projects_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."projects"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "autocomplete_data" DROP COLUMN "frequency";--> statement-breakpoint
ALTER TABLE "material_purchases" DROP COLUMN "material_name";--> statement-breakpoint
ALTER TABLE "material_purchases" DROP COLUMN "unit";--> statement-breakpoint
ALTER TABLE "material_purchases" DROP COLUMN "receipt_number";--> statement-breakpoint
...
ALTER TABLE "projects" DROP COLUMN "client_phone";--> statement-breakpoint
...
ALTER TABLE "worker_attendance" DROP COLUMN "attendance_date";--> statement-breakpoint
ALTER TABLE "worker_attendance" DROP COLUMN "hours_worked";--> statement-breakpoint
ALTER TABLE "worker_attendance" DROP COLUMN "overtime";--> statement-breakpoint
ALTER TABLE "worker_attendance" DROP COLUMN "overtime_rate";--> statement-breakpoint
ALTER TABLE "worker_attendance" DROP COLUMN "total_pay";--> statement-breakpoint
ALTER TABLE "worker_attendance" DROP COLUMN "notes";--> statement-breakpoint
ALTER TABLE "workers" DROP COLUMN "phone";--> statement-breakpoint
ALTER TABLE "workers" DROP COLUMN "status";--> statement-breakpoint
ALTER TABLE "workers" DROP COLUMN "hired_date";--> statement-breakpoint
ALTER TABLE "workers" DROP COLUMN "notes";--> statement-breakpoint
