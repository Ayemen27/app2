...
## التغييرات الأخيرة
- 2026-02-12: ترقية أداة `apk.sh` إلى الإصدار 20.0.0 (المعماري النهائي).
- حل تعارضات الملفات المكررة في بناء الأندرويد عبر استراتيجية `pickFirst`.
- إعادة بناء هيكلية مشروع الأندرويد عن بُعد وإصلاح ملفات `Gradle`.
- الربط التلقائي مع السيرفر الخارجي باستخدام `sshpass` لضمان استمرارية البناء.
- معالجة مشاكل توافقية SDK 35 ومكتبات AndroidX core.
- أتمتة إصلاح ملفات `google-services.json` لضمان عمل خدمات Firebase.
