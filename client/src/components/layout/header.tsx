...
const pageInfo: Record<string, { title: string; icon: any }> = {
  ...
  '/wells/crews': { title: 'إدارة الفرق والنقل', icon: Users },
  '/wells/materials': { title: 'كشف المواد الشمسية والمواسير', icon: Package },
  '/wells/receptions': { title: 'الاستلام والفحص', icon: UserCheck },
